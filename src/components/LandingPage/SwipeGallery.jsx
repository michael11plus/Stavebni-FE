		...
		<>
			...
			>
				<Carousel.Item className="position-relative">
					<img
						className="w-100 flipped-image"
						src={kitchen_1}
						alt="Mordern kitchen 1"
					/>
					<div className="layer"></div>
					<Carousel.Caption className="d-flex flex-column justify-content-center position-absolute a--fade-in-move-up">
						<Container
							fluid
							className="base-width d-flex flex-column align-items-center align-items-md-start"
						>
							<h3 className="">Náš poslední projekt</h3>
							<p className="">
								Tento projekt je realizován ve spolupráci s
								xyz.cz
							</p>

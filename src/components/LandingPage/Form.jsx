...
const Form = () => {
	...
	return (
		<Container ref={formRef} className="section form" fluid>
			<Row
				className={`bg-white base-width ${formHit ? 'a--fade-in-move-up' : 'opacity-0'}`}
			>
				<Col xs={12} md={5} className="form-container--right-bottom">
					...
					>
						<p className="form--header-text mb-5">Napište nám</p>
						<FormControl
							fullWidth
							variant="outlined"
							className="mb-3"
						...
						<FormControlLabel
							...
							label={
								...
								>
									...
									<span className="form--conditions-agreement-text">
				...
				<Col
					xs={12}
					md={6}
					className="form-container--left-top d-none d-md-flex flex-md-column align-items-center"
				>
					<p
						className="form--header-text mb-5"
						style={{ fontWeight: '400' }}
					>
						Konzultace zdarma
					</p>
					<p style={{ fontSize: '1.5rem', fontWeight: '300' }}>
						Ať už máte otázky, potřebujete radu, nebo si chcete
						promluvit o svém projektu, náš tým je připraven vás
						podpořit – bez jakýchkoli závazků.
					</p>
				</Col>
			</Row>
		</Container>

...
import { serviceConstructionHeader } from '../../assets';
...
const ServiceConstruction = () => {
    ...
    return(
        <Container fluid className='p-0'>
                ...
                <Col className='position-relative p-0'>
                    <div
                        ...
                        style={{
                            ...
                            height: '400px',
                            transform: '',
                            background: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${serviceConstructionHeader})`,
            ...
            <Row className='base-width mx-auto'>
